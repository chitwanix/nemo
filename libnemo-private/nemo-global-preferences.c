...
nemo_global_preferences_init (void)
{
	...
	gnome_lockdown_preferences = g_settings_new("org.sagarmatha.desktop.lockdown");
	gnome_background_preferences = g_settings_new("org.sagarmatha.desktop.background");
	gnome_media_handling_preferences = g_settings_new("org.sagarmatha.desktop.media-handling");
	gnome_terminal_preferences = g_settings_new("org.sagarmatha.desktop.default-applications.terminal");
